...
- **Fee check is a hard stop.** If STX balance is below the minimum fee (0.5 STX + buffer), surface the shortfall and abort — do not attempt partial exits.
...
3. run --pool-id dlmm_6 --address SP301E...
   → action: dry_run | binsToExit: 220 | totalDlp: 499221
...
5. run --pool-id dlmm_6 --address SP301E... --confirm
   ...
   → binsExited: 220 | totalDlp: 499221
